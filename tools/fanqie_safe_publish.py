...
def main() -> int:
    ...
    if args.submit and (not args.fill or args.confirm_submit != expected_sha):
        raise SystemExit("Submit refused: requires --fill and --confirm-submit equal to content SHA256")
    ...
    with sync_playwright() as p:
        ...
        if args.submit:
            # Submit path is intentionally narrow and requires a visible confirmation flow.
